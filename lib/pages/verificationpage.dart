...
import 'package:gogreen/pages/ticketpage.dart';

class VerificationPage extends StatefulWidget {
  final BookingDetails bookingDetails;
  const VerificationPage({Key? key, required this.bookingDetails})
      : super(key: key);
...
class _VerificationPageState extends State<VerificationPage> {
  ...
  void VerifyOtp() async {
    ...
    if (await myauth.verifyOTP(otp: fullOtp) == true) {
      ...
      saveBookingDetailsToFirebase(widget.bookingDetails);
      Navigator.push(
        context,
        CupertinoPageRoute(
          builder: (context) =>
              TicketPage(bookingDetails: widget.bookingDetails),
        ),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> saveBookingDetailsToFirebase(
